# Generated by Django 4.2.8 on 2025-11-14 14:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reward_suggestions', to='Quanlyhoso.employee')),
                ...
                ('suggested_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='suggestions_made', to='Quanlyhoso.employee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('LEADER', 'Trưởng dự án'), ('MEMBER', 'Thành viên')], default='MEMBER', max_length=100, verbose_name='Vai trò')),
                ('added_date', models.DateField(auto_now_add=True, verbose_name='Ngày tham gia')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_assignments', to='Quanlyhoso.employee', verbose_name='Mã Nhân Viên')),
        ...
        migrations.AddField(
            model_name='project',
            name='employee',
            field=models.ManyToManyField(related_name='employee_projects', through='Khenthuong.ProjectEmployee', to='Quanlyhoso.employee'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='performancereview',
            name='employee',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews_received', to='Quanlyhoso.employee'),
        ),
        migrations.AddField(
            model_name='performancereview',
            name='reviewer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews_given', to='Quanlyhoso.employee'),
        ),
        migrations.CreateModel(
            name='RewardList',
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reward_lists', to='Quanlyhoso.employee')),
                ('reward_announce', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Khenthuong.rewardannounce', verbose_name='Thông báo áp dụng')),
                ('reward_item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Khenthuong.reward', verbose_name='Hạng mục nhận thưởng')),
            ],
            options={
