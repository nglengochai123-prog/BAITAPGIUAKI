    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_assignments', to='Quanlyhoso.employee')),
        ...
        migrations.AddField(
            model_name='project',
            name='led_project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='led_projects', to='Quanlyhoso.employee'),
        ),
        migrations.AddField(
